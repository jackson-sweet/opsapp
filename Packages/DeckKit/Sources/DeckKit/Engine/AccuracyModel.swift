...
public struct AccuracyModel {
    ...
    public static func estimateAccuracy(distanceMeters: Double) -> Double {
    ...
    public static func formatAccuracy(
    ...
    public static func areaAccuracy(edgeAccuracies: [(Double, Double)]) -> Double {
    ...
    public static func perimeterAccuracy(edgeAccuracies: [(Double, Double)]) -> Double {
        guard !edgeAccuracies.isEmpty else { return 0 }
    ...
    public static func postCountError(edgeLengthInches: Double, accuracyPercent: Double, maxSpacing: Double) -> Int {
    ...
    public static func allEdgesVerified(_ drawingData: DeckDrawingData) -> Bool {
