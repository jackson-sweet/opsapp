...
public struct PolygonMath {
    ...
    public static func area(vertices: [CGPoint]) -> Double {
    ...
    public static func signedArea(vertices: [CGPoint]) -> Double {
    ...
    public static func realWorldArea(vertices: [CGPoint], scaleFactor: Double) -> Double {
    ...
    public static func perimeter(vertices: [CGPoint]) -> Double {
    ...
    public static func edgeLength(from start: CGPoint, to end: CGPoint) -> Double {
    ...
    public static func pointInPolygon(_ point: CGPoint, vertices: [CGPoint]) -> Bool {
    ...
    public static func isSelfIntersecting(vertices: [CGPoint]) -> Bool {
        let n = vertices.count
    ...
    public static func closestPointOnSegment(
        point: CGPoint,
        segStart: CGPoint,
        segEnd: CGPoint
    ...
    public static func findEdgeAtPoint(
        _ point: CGPoint,
        edges: [DeckEdge],
        vertices: [DeckVertex],
    ...
    public static func findVertexAtPoint(
        _ point: CGPoint,
        vertices: [DeckVertex],
    ...
    public static func outwardPerpendicular(
        edgeStart: CGPoint,
        edgeEnd: CGPoint,
