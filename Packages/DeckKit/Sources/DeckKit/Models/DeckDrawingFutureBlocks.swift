...
public enum DeckJSONValue: Equatable {
    case string(String)
    case number(String)
    case bool(Bool)
    ...
    public static func parseObject(from json: String) throws -> [String: DeckJSONValue] {
    ...
    public func renderedJSONString() throws -> String {
...
public enum DeckJSONValueError: Error {
    case expectedObject
...
private enum DeckJSONRenderer {
    public static func render(_ value: DeckJSONValue) throws -> String {
        switch value {
