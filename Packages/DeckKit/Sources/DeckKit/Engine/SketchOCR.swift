...
public struct SketchOCR {
    ...
    public static func recognize(image: CGImage) async -> [RecognizedText] {
    ...
    /// 5. Unknown
    public static func classifyText(_ text: String, boundingBox: CGRect, imageSize: CGSize) -> TextClassification {
