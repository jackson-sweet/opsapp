    ...
    var body: some View {
        VStack(spacing: 0) {
            if viewModel.is3DMode {
                ...
                ZStack(alignment: .top) {
                    ...
                    .padding(.bottom, 8)
                    .animation(OPSStyle.Animation.smooth, value: viewModel.showMeasurementToast)
                    .animation(OPSStyle.Animation.smooth, value: viewModel.showLaserErrorToast)
                    .animation(OPSStyle.Animation.smooth, value: viewModel.showDisconnectToast)
                    .animation(OPSStyle.Animation.smooth, value: viewModel.showAssignmentToast)
        ...
        .overlay(alignment: .bottom) {
            if viewModel.estimateCreated, let number = viewModel.createdEstimateNumber {
                ...
                .padding(.bottom, 80)
                .transition(.move(edge: .bottom).combined(with: .opacity))
                .animation(OPSStyle.Animation.smooth, value: viewModel.estimateCreated)
            }
        }
        // Save error toast
        ...
        .animation(OPSStyle.Animation.smooth, value: viewModel.saveError)
        ...
        .animation(OPSStyle.Animation.smooth, value: viewModel.showUndoLevelToast)
