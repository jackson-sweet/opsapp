...
struct ProjectSearchSheet: View {
    ...
    private var taskSearchToggleSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            HStack {
                Image(OPSStyle.Icons.checklist)
                    .font(.system(size: OPSStyle.Layout.IconSize.sm))
                    .foregroundColor(OPSStyle.Colors.primaryText)
                ...
                HStack {
                    ...
                    ZStack {
                        ...
                        if searchInTasks {
                            ...
                            Image(OPSStyle.Icons.checkmarkCircle)
    ...
    private var taskTypeFilterSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            HStack {
                Image(OPSStyle.Icons.tradeGeneral)
                    .font(.system(size: OPSStyle.Layout.IconSize.sm))
                    .foregroundColor(OPSStyle.Colors.primaryText)
    ...
    private var projectListSection: some View {
        Group {
            if isLoading {
                ...
                Spacer()
                VStack(spacing: 16) {
                    Image(searchText.isEmpty ? OPSStyle.Icons.project : OPSStyle.Icons.search)
