...
struct SketchAIFallback {
    ...
    static func analyze(image: CGImage, apiKey: String) async throws -> SketchScanResult {
        let imageSize = CGSize(width: image.width, height: image.height)

        // Convert CGImage to base64 JPEG
    ...
    enum AIFallbackError: LocalizedError {
